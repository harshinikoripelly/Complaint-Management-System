...
const registerComplaint = async (req, res) => {
    ...
    const {idno,category,name,description,date,status,feedback,feedbackdate} = req.body;


    try {
        const user = await Complaint.register(idno,category,name,description,date,status,feedback,feedbackdate);
...
const changeStatus = async (req, res) => {
    ...
    const {_id,idno,category,name,description,date,status,feedback,feedbackdate} = req.body;
    console.log("controller",_id,idno,category,name,description,date,status,feedback,feedbackdate);
    ...
    try {
        ...
        const updatedComplaint = await Complaint.findByIdAndUpdate(
            _id,
            {idno,category,name,description,date,status,feedback,feedbackdate},
            {new: true}
        );
