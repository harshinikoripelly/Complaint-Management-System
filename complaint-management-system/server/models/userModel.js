...
complaintSchema.statics.register = async function(idno,category,name,description,date,status,feedback) {

    console.log(idno,category,name,description,date,status,feedback);
    ...
    const complaint = await this.create({idno,category,name,description,date,status,feedback})
