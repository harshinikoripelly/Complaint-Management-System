...
const useSignup = () => {
    ...
    const register = async (idno,category,name,description,date,status,feedback,feedbackdate)=>{


        const response = await fetch('/api/user/complaint',{
            method:'POST',
            headers:{"Content-Type":"application/json"},
            body:JSON.stringify({idno,category,name,description,date,status,feedback,feedbackdate})
        })
    ...
    const updateComplaint = async (_id,idno,category,name,description,date,status,feedback,feedbackdate)=>{


        console.log(_id,idno,category,name,description,date,status,feedback,feedbackdate);

        const response = await fetch('/api/user/history',{
            method:'PUT',
            headers:{"Content-Type":"application/json"},
            body:JSON.stringify({_id,idno,category,name,description,date,status,feedback,feedbackdate})
        })
